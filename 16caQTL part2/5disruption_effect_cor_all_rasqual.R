...
out.dir <- '~/yuzhao1/work/atac_gca2024/24rasqual2/5disruption_effect_cor_all_rasqual/'
...
# read effect sizes
prep.dir <- '~/yuzhao1/work/atac_gca2024/24rasqual2/4prepare_qtls/'
df_effect <- readRDS(paste0(prep.dir, 'df_effect.rds'))
