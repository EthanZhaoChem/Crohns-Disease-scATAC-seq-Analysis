...
# read gwas lead snps
gwas_lead_df <- read.csv('~/yuzhao1/work/atac_gca2024/19rasqual/8LDoverlap/gwas_cd/cd_finemapping_unifprior_95loci_L10_annotated.csv')
...
# mash QTLs
write.csv(overlapped_snp_pairs, '/project/gca/yuzhao1/work/atac_gca2024/24rasqual2/3qtls_gwas_overlap/gwas_rasqual_caQTL_LD08.csv')
