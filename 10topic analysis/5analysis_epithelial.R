...
# fixed
lineage <- 'epithelial'
lineage.anno1 <- gca_colors_atac_epithelial_anno1
...
load(paste0(data.dir, "epithelial_raw_sub100.RData"))
...
# fixed
file_fasttopic <- paste0('~/yuzhao1/work/atac_gca2024/13fasttopic/rds/fit_epithelial_sub100_k',  nTopics, '_converged.rds')
file_fasttopic_de <- paste0('~/yuzhao1/work/atac_gca2024/13fasttopic/rds/fit_epithelial_sub100_k',  nTopics, '_converged_de_default.rds')
plot.dir <- paste0('~/yuzhao1/work/atac_gca2024/13fasttopic/plots/epithelial_sub100_k', nTopics, '/')
...
parallel_results_dir <- '~/yuzhao1/work/atac_gca2024/13fasttopic/rds/fit_epithelial_sub100_k25_converged_de_vsnull/'
nThreads <- 20
