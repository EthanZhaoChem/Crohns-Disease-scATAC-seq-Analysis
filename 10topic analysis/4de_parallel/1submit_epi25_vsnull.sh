...
# need to change
Dir_tmp=$Dir_root/fit_epithelial_sub100_k25_converged_de_vsnull
file_counts=$Dir_root/epithelial_raw_sub100.RData
file_fasttopic=$Dir_root/fit_epithelial_sub100_k25_converged.rds
jobTitle=epi25
