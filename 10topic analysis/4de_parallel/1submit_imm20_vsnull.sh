...
# need to change
Dir_tmp=$Dir_root/fit_immune_sub100_k20_converged_de_vsnull
file_counts=$Dir_root/immune_raw_sub100.RData
file_fasttopic=$Dir_root/fit_immune_sub100_k20_converged.rds
jobTitle=imm20
