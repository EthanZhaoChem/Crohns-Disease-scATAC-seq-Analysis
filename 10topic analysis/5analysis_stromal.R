...
# fixed
lineage <- 'stromal'
lineage.anno1 <- gca_colors_atac_stromal_anno1
...
load(paste0(data.dir, "stromal_raw_sub100.RData"))
...
# fixed
file_fasttopic <- paste0('~/yuzhao1/work/atac_gca2024/13fasttopic/rds/fit_stromal_sub100_k',  nTopics, '_converged.rds')
file_fasttopic_de <- paste0('~/yuzhao1/work/atac_gca2024/13fasttopic/rds/fit_stromal_sub100_k',  nTopics, '_converged_de_default.rds')
plot.dir <- paste0('~/yuzhao1/work/atac_gca2024/13fasttopic/plots/stromal_sub100_k', nTopics, '/')
...
set.seed(2)
pdf(paste0(plot.dir, 'structure_plot_', lineage, '_sub', subID, '_k_', nTopics, '_anno1_partial.pdf'), height = 2, width = 4)
...
daPeaks.dir <- paste0(plot.dir, 'daPeaks_positive_flexibleLpval30k/')
...
write.xlsx(motifs_perTopic_daPeaks, file = paste0(plot.dir, 'enriched_motif_from_daPeaks_positive_flexibleLpval30k_', 'sub', subID, '_k_', nTopics, '.xlsx'))
...
parallel_results_dir <- '~/yuzhao1/work/atac_gca2024/13fasttopic/rds/fit_stromal_sub100_k10_converged_de_vsnull/'
nThreads <- 20
