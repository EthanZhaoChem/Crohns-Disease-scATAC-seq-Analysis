...
resultPath_txt <- paste0("~/yuzhao1/work/final_GCAatac/18glimpse/4.3sample_concordance_all_chr1/", sample1, '_', sample2, ".txt")


# Load the VCF file
vcfFilePath1 <- paste0("~/yuzhao1/work/final_GCAatac/18glimpse/2.3eagle/", sample1, "/", sample1,  "_chr1.vcf.gz")
vcfFilePath2 <- paste0("~/yuzhao1/work/final_GCAatac/18glimpse/2.3eagle/", sample2, "/", sample2,  "_chr1.vcf.gz")
