...
resultPath_txt <- paste0("~/yuzhao1/work/final_GCAatac/18glimpse/4.2patient_sample_concordance/", sample1, '_', sample2, ".txt")


# Load the VCF file
vcfFilePath1 <- paste0("~/yuzhao1/work/final_GCAatac/18glimpse/3.4concat/", sample1, ".vcf.gz")
