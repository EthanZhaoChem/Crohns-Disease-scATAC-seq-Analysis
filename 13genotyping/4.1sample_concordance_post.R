library(stringr)
sample_pairs_all <- readLines('~/yuzhao1/work/final_GCAatac/18glimpse/4.0prepare_samplePair.txt')
...
write.csv(df, '~/yuzhao1/work/final_GCAatac/18glimpse/4.1sample_concordance/00summary_NRC.csv')
