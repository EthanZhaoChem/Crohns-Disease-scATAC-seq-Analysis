...
out.dir <- '~/yuzhao1/work/atac_gca2024/5TF/output/'
...
```{r}
proj$anno1_inflammation_status_location <- paste0(proj$anno1, '_', proj$inflammation_status, '_', proj$biopsy_location)
seGroupMotif <- getGroupSE(ArchRProj = proj, useMatrix = "cisbp", groupBy = "anno1_inflammation_status_location")
```
...
```{r}
saveRDS(corGIM_MM, paste0(proj@projectMetadata$outputDirectory, '/corGIM_MM_anno1_inflammation_status_location.rds'))
```



```{r}
corGIM_MM <- readRDS(paste0(proj@projectMetadata$outputDirectory, '/corGIM_MM_anno1_inflammation_status_location.rds'))
```
...
pdf(paste0(out.dir, temp_lineage, '/regulator_anno1_inflammation_status_location.pdf'), width = 8, height = 8, pointsize = 1)
p
dev.off()

saveRDS(df, paste0(out.dir, temp_lineage, '/regulator_df_anno1_inflammation_status_location.rds'))
```
