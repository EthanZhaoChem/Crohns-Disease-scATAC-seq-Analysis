...
out.dir <- '~/yuzhao1/work/atac_gca2024/0manu/plots/2atac_MarkerPeaks_location/'
out.dir.tf <- '~/yuzhao1/work/atac_gca2024/0manu/plots/2atac_MarkerTFs_location/'
```
...
markersPeaks <- readRDS(paste0(proj@projectMetadata$outputDirectory, '/', 'MarkersPeaks_', temp_lineage, '_', celltype, '.rds'))

pma <- markerPlot(seMarker = markersPeaks, name = "Ileum BEST4-TI-Control", cutOff = "FDR <= 0.01 & abs(Log2FC) >= 1", plotAs = "MA")
pv <- markerPlot(seMarker = markersPeaks, name = "Ileum BEST4-TI-Control", cutOff = "FDR <= 0.01 & abs(Log2FC) >= 1", plotAs = "Volcano")
