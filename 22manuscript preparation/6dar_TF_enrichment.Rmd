...
```{r}
## read inf peaks
filename <- '~/yuzhao1/work/atac_gca2024/7dreamlet/differential_test/tfs_inf_vs_control_allCelltypes_FC05_adjP01.xlsx'
...
pdf(paste0(out.dir, 'TF_cutoff2_maxN50_cap5.pdf'), height = 4.5, width = 15)
