...
script_submission=/project/gca/yuzhao1/work/atac_gca2024/19rasqual/4calculation_all_peaks/4.2rasqual_wrapper.batch
rasqual_output_dir_root=/scratch/midway3/yuzhao1/rasqual/allPeaks_noDiseaseCo/result
...
do
  ...
  do 
      ...
      sbatch -J ${ct}_${block_index} --time=36:00:00 --mem=10G --output=$tmp_dir/${ct}_${block_index}.out --error=$tmp_dir/${ct}_${block_index}.err --account=pi-onibasu  -p caslake -c 10 --wrap="$cmd"
      # exit 1
  done
